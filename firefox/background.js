// Starlink Form Submitter - Background Script (Firefox MV2)
...
// Regex flexible: ACC-DF-... ou ACC-...-...-... (lettres ou chiffres dans les segments)
  ...
  function (details) {
    try {
      ...
      if (m && m[1]) {
        ...
        browserAPI.runtime.sendMessage({ type: "ACCOUNT_DETECTED", accountNumber: acc })
          .catch(function () {});
...
// Au clic sur l'icone, ouvre la page formulaire directement
