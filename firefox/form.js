  ...
  "customer-details-put-kyc": {
    ...
    fields: [
      ...
      { key: "verificationDeadlineDate", type: "date", value: "", enabled: false, group: "inner",
        hint: "Date limite de verification (ISO date). Active si requis." },
      { key: "verificationExpiryDate", type: "date", value: "", enabled: false, group: "inner",
        hint: "Date d'expiration de la verification (ISO date)." },
      { key: "fullLegalName", type: "string", value: "", enabled: false, group: "inner",
        hint: "Pas dans le jsonSchema v7 - active si le serveur le reclame." },
      { key: "nationality", type: "string", value: "FR", enabled: false, group: "inner",
        hint: "Pas dans le jsonSchema v7." },
      { key: "dateOfBirth", type: "date", value: "1990-01-01", enabled: false, group: "inner",
        hint: "Pas dans le jsonSchema v7." },
